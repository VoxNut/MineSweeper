...
<%
    // UC-9 (9.1.8): Đọc tham số difficulty từ request attribute do LeaderboardServlet gán.
    // Nếu null hoặc rỗng, mặc định hiển thị "all" (tất cả mức độ khó) — UC-9, BR3.
...
<div class="page">
    <div class="card wide cozy">
        ...
        <form method="get" action="<%= request.getContextPath() %>/leaderboard" class="row">
            ...
            <%-- UC-9 (9.2.4): Mỗi option được đánh dấu "selected" nếu khớp
                 với giá trị difficulty hiện tại — giữ lại trạng thái bộ lọc sau khi submit. --%>
        ...
        <%-- UC-9 (9.1.10): Bảng hiển thị kết quả xếp hạng.
             Các cột: Rank (#), Player, Difficulty, Time (s), Elo, Played At. --%>
        <table class="table">
            <thead>
            <tr>
                <th>#</th>
            ...
            <tr>
                ...
                <%-- UC-9 (9.1.11): Nếu eloAfter <= 0, hiển thị "-" thay cho giá trị Elo. --%>
